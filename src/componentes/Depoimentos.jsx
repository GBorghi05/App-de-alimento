...
// --- Ícone (incluído para o componente ser independente) ---
  ...
  return (
    <section className="py-16 sm:py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* --- LAYOUT RESPONSIVO ---
          - Por padrão (mobile) é 1 coluna
          - md:grid-cols-2: Em tablets, vira 2 colunas
          - lg:grid-cols-3: Em desktops, vira 3 colunas
        */}
